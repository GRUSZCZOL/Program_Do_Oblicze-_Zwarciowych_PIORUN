...
namespace Program_Do_Obliczeń_Zwarciowych_PIORUN
{
    public partial class FormSetLine : Form
    {
        ...
        {
            Database.ListOfLineData.Add(new Line_Data() { Name = comboBox_Form_Set_Line.Text, PoleType = comboBox3.SelectedText, _2Way = checkBox1.CausesValidation, temp = Convert.ToDouble(textBox_Temp.Text), resistivity = Convert.ToDouble(textBox_Resistivity_GND.Text), lenght = Convert.ToDouble(textBox_Lenght_value.Text), conductivity = Convert.ToDouble(textBox_Conductivity_value.Text), cross_section = Convert.ToDouble(textBox_S_value.Text), r = Convert.ToDouble(textBox_r_value.Text), r_0 = Convert.ToDouble(textBox_r_0_value.Text), mediumdistance1 = Convert.ToDouble(textBox_Line_1_Geometric_Distance_1.Text), mediumdistance2 = Convert.ToDouble(textBox_Line_2_Geometric_Distance_2.Text), D1_1 = Convert.ToDouble(textBox_Line_1_D1.Text), D2_1 = Convert.ToDouble(textBox_Line_1_D2.Text), D3_1 = Convert.ToDouble(textBox_Line_1_D3.Text), D1_2 = Convert.ToDouble(textBox_Line_2_D1.Text), D2_2 = Convert.ToDouble(textBox_Line_2_D2), D3_2 = Convert.ToDouble(textBox_Line_2_D3.Text), D_w = Convert.ToDouble(textBox_D_w.Text) });
            comboBox_Form_Set_Line.DataSource = null;
            comboBox_Form_Set_Line.DataSource = Database.ListOfLineData;
            comboBox_Form_Set_Line.DisplayMember = "Name";
        }  // DOPORPRAWY!!!!!!!!
